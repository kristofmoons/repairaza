...
INSERT INTO "PUBLIC"."ITEM" VALUES
                                (nextval('ITEM_SEQ'), TRUE,'een horloge van omega gemaakt voor te gaan duiken', 'omega seamaster', 1000.0, 'watch',1),
                                ...
                                (nextval('ITEM_SEQ'), FALSE,'een elecktrische gitaar van gibson', 'gipson stratocaster', 2000.0, 'instrument',1),
                                (nextval('ITEM_SEQ'), FALSE, 'een horloge met een sepciale look van tissot', 'tissot couturier', 600.0, 'watch',1);
